...
#define PyContext_CheckExact(o) (_Py_TYPE(o) == &PyContext_Type)
#define PyContextVar_CheckExact(o) (_Py_TYPE(o) == &PyContextVar_Type)
#define PyContextToken_CheckExact(o) (_Py_TYPE(o) == &PyContextToken_Type)
